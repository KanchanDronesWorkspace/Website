...
export function getViewMatrix(camera: CameraData) {
...
export function invert4(a: number[]) {
...
export function rotate4(a: number[], rad: number, x: number, y: number, z: number) {
...
export function translate4(a: number[], x: number, y: number, z: number) {
    return [
        ...a.slice(0, 12),
...
// Default camera positions for the scene
export const defaultCameras: CameraData[] = [
    {
        id: 0,
        img_name: "00001",
        width: 1959,
